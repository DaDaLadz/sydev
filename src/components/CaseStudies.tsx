    ...
    <section id="case-studies" className="scroll-section section-padding relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-8 md:mb-10">
          <span className="text-green text-xs font-bold uppercase tracking-[0.3em] mb-2 block">Client Results</span>
          <h2 className="text-3xl md:text-5xl font-display uppercase tracking-wider mb-3 text-black">
            ...
            <div key={caseStudy.id} className="relative cursor-pointer group h-full">
              <div className="h-full bg-card rounded-2xl overflow-hidden border transition-all duration-500 flex flex-col border-gray-800/50 hover:border-gray-700">
                ...
                <div className="p-5 flex flex-col flex-grow">
                  <h3 className="text-xl md:text-2xl font-bold uppercase tracking-tight mb-1 transition-colors duration-300 text-black">
                    {caseStudy.brand}
                  </h3>
                  <p className="text-xs text-gray-600 uppercase tracking-wider mb-4">{caseStudy.industry}</p>

                  {/* Stats Grid */}
                  <div className="grid grid-cols-2 gap-2 flex-grow">
                    {caseStudy.stats.map((stat, index) => (
                      <div key={index} className="text-center bg-gray-800/40 rounded-lg py-2 px-2">
                        <div
                        ...
                        <div className="text-[10px] text-gray-600 uppercase tracking-wider mt-0.5">{stat.label}</div>
                      </div>
                    ))}
                  </div>
                </div>
